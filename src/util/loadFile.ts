...
type TournamentPageType = 'meta' | 'general' | 'matchups' | 'resources' | 'mapsPlayed' | 'supply' | 'workers' | 'popularUnits' | 'unitsBuilt' | 'fullMatchupStats' | 'upgradesCount' | 'upgradesTimes'
