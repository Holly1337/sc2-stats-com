    ...
    return (
        <div className={styles.matchup}>
            <div className={'text-center'}>
                ...
                <div className='d-flex flex-column' style={{ fontSize: 24 }}>
                    <div className='d-flex align-items-center justify-content-evenly' style={{ marginTop: 12 }}>
                        {icons[race1]}
                    ...
                    {
                        (race1 !== race2) && (
                            <div className='d-flex justify-content-evenly' style={{ marginTop: 24 }}>
                                <span style={{ width: 64 }}>{winrateRace1}%</span>
                                <span className={styles.ratio}>{race1Wins}:{race2Wins}</span>
