...
export const WorkerSection = () => {
  const { matchups, unitsBuilt, previousEvent } = tournamentData
  const { name: previousName, workers: previousWorkers } = previousEvent
  ...
  const data = {
    SCV: unitsBuilt.SCV,
    Drone: unitsBuilt.Drone,
    Probe: unitsBuilt.Probe
  }
  const previousAverage = {
    SCV: previousWorkers.scv,
    Drone: previousWorkers.drone,
    Probe: previousWorkers.probe
  }
